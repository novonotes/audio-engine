...
class DeviceDescriptorController {
  ...
  DeviceDescriptorController(EngineMessageChannel channel)
    ...
    _subscription =
      ...
      (msg) {
        ...
        // Response の場合
        if (bodyType ==
            pb.BodyType.BODY_TYPE_LIST_DEVICE_DESCRIPTORS_RESPONSE) {
          final res = pb.ListDeviceDescriptorsResponse.fromBuffer(body);
  ...
  Future<pb.ListDeviceDescriptorsResponse> listDeviceDescriptors(
    pb.ListDeviceDescriptorsRequest req, {
