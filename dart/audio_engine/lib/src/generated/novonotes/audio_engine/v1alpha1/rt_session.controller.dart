...
class RtSessionController {
  ...
  RtSessionController(EngineMessageChannel channel)
    ...
    _subscription =
      ...
      (msg) {
        ...
        // Response の場合
        if (bodyType == pb.BodyType.BODY_TYPE_START_RT_SESSION_RESPONSE) {
          final res = pb.StartRtSessionResponse.fromBuffer(body);
          _requestExecutor.handleResponse(res, requestId);
          return;
        }

        if (bodyType == pb.BodyType.BODY_TYPE_STOP_RT_SESSION_RESPONSE) {
          final res = pb.StopRtSessionResponse.fromBuffer(body);
          _requestExecutor.handleResponse(res, requestId);
          return;
        }
      },
  ...
  Future<pb.StartRtSessionResponse> startRtSession(
    pb.StartRtSessionRequest req, {
  ...
  Future<pb.StopRtSessionResponse> stopRtSession(
    pb.StopRtSessionRequest req, {
    Duration timeout = defaultRequestTimeout,
  }) async {
    return _requestExecutor.execute(
      req,
