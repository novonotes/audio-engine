...
class DebugUtilityController {
  ...
  DebugUtilityController(EngineMessageChannel channel)
    ...
    _subscription =
      ...
      (msg) {
        ...
        // Response の場合
        if (bodyType == pb.BodyType.BODY_TYPE_DEBUG_STATE_RESPONSE) {
          final res = pb.DebugStateResponse.fromBuffer(body);
          _requestExecutor.handleResponse(res, requestId);
          return;
        }

        if (bodyType == pb.BodyType.BODY_TYPE_SAVE_STATE_RESPONSE) {
          final res = pb.SaveStateResponse.fromBuffer(body);
          _requestExecutor.handleResponse(res, requestId);
          return;
        }
      },
  ...
  Future<pb.DebugStateResponse> debugState(
    pb.DebugStateRequest req, {
  ...
  Future<pb.SaveStateResponse> saveState(
    pb.SaveStateRequest req, {
    Duration timeout = defaultRequestTimeout,
  }) async {
    return _requestExecutor.execute(
      req,
