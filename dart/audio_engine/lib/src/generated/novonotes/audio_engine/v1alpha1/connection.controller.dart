...
import 'package:audio_engine/src/generated/google/protobuf/struct.pb.dart'
    as pb;
import 'connection.pb.dart' as pb;
...
class ConnectionController {
  ...
  ConnectionController(EngineMessageChannel channel)
    ...
    _subscription =
      ...
      (msg) {
        ...
        // Response の場合
        if (bodyType == pb.BodyType.BODY_TYPE_CONNECT_RESPONSE) {
          final res = pb.ConnectResponse.fromBuffer(body);
          _requestExecutor.handleResponse(res, requestId);
          return;
        }

        if (bodyType == pb.BodyType.BODY_TYPE_DISCONNECT_RESPONSE) {
          final res = pb.DisconnectResponse.fromBuffer(body);
          _requestExecutor.handleResponse(res, requestId);
          return;
        }
      },
  ...
  Future<pb.ConnectResponse> connect(
  ...
  Future<pb.DisconnectResponse> disconnect(
