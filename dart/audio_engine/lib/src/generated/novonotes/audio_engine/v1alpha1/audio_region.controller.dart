...
class AudioRegionController {
  ...
  AudioRegionController(EngineMessageChannel channel)
    ...
    _subscription =
      ...
      (msg) {
        ...
        // Response の場合
        if (bodyType == pb.BodyType.BODY_TYPE_CREATE_AUDIO_REGION_RESPONSE) {
          final res = pb.CreateAudioRegionResponse.fromBuffer(body);
          _requestExecutor.handleResponse(res, requestId);
          return;
        }

        if (bodyType == pb.BodyType.BODY_TYPE_UPDATE_AUDIO_REGION_RESPONSE) {
          final res = pb.UpdateAudioRegionResponse.fromBuffer(body);
          _requestExecutor.handleResponse(res, requestId);
          return;
        }

        if (bodyType == pb.BodyType.BODY_TYPE_DELETE_AUDIO_REGION_RESPONSE) {
          final res = pb.DeleteAudioRegionResponse.fromBuffer(body);
          _requestExecutor.handleResponse(res, requestId);
          return;
        }
      },
  ...
  Future<pb.CreateAudioRegionResponse> createAudioRegion(
    pb.CreateAudioRegionRequest req, {
  ...
  Future<pb.UpdateAudioRegionResponse> updateAudioRegion(
    pb.UpdateAudioRegionRequest req, {
    Duration timeout = defaultRequestTimeout,
  }) async {
    return _requestExecutor.execute(
      req,
  ...
  Future<pb.DeleteAudioRegionResponse> deleteAudioRegion(
    pb.DeleteAudioRegionRequest req, {
    Duration timeout = defaultRequestTimeout,
  }) async {
    return _requestExecutor.execute(
      req,
