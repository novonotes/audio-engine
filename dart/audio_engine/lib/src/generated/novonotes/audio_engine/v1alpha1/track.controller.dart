...
class TrackController {
  ...
  TrackController(EngineMessageChannel channel)
    ...
    _subscription =
      ...
      (msg) {
        ...
        // Response の場合
        if (bodyType == pb.BodyType.BODY_TYPE_CREATE_TRACK_RESPONSE) {
          final res = pb.CreateTrackResponse.fromBuffer(body);
          _requestExecutor.handleResponse(res, requestId);
          return;
        }

        if (bodyType == pb.BodyType.BODY_TYPE_UPDATE_TRACK_RESPONSE) {
          final res = pb.UpdateTrackResponse.fromBuffer(body);
          _requestExecutor.handleResponse(res, requestId);
          return;
        }

        if (bodyType == pb.BodyType.BODY_TYPE_DELETE_TRACK_RESPONSE) {
          final res = pb.DeleteTrackResponse.fromBuffer(body);
          _requestExecutor.handleResponse(res, requestId);
          return;
        }
      },
  ...
  Future<pb.CreateTrackResponse> createTrack(
    pb.CreateTrackRequest req, {
  ...
  Future<pb.UpdateTrackResponse> updateTrack(
    pb.UpdateTrackRequest req, {
    Duration timeout = defaultRequestTimeout,
  }) async {
    return _requestExecutor.execute(
      req,
  ...
  Future<pb.DeleteTrackResponse> deleteTrack(
    pb.DeleteTrackRequest req, {
    Duration timeout = defaultRequestTimeout,
  }) async {
    return _requestExecutor.execute(
      req,
