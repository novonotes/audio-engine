...
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_google_2fapi_2ffield_5fbehavior_2eproto =
        nullptr;
const ::uint32_t
    TableStruct_google_2fapi_2ffield_5fbehavior_2eproto::offsets[1] = {};
static constexpr ::_pbi::MigrationSchema* schemas = nullptr;
static constexpr ::_pb::Message* const* file_default_instances = nullptr;
const char descriptor_table_protodef_google_2fapi_2ffield_5fbehavior_2eproto
...
const ::google::protobuf::EnumDescriptor* FieldBehavior_descriptor()
{
    ::google::protobuf::internal::AssignDescriptors(
        &descriptor_table_google_2fapi_2ffield_5fbehavior_2eproto);
    return file_level_enum_descriptors_google_2fapi_2ffield_5fbehavior_2eproto
        [0];
}
...
bool FieldBehavior_IsValid(int value) { return 0 <= value && value <= 8; }
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 ::_pbi::ExtensionIdentifier<
    ::google::protobuf::FieldOptions,
    ::_pbi::RepeatedEnumTypeTraits<::google::api::FieldBehavior,
                                   ::google::api::FieldBehavior_IsValid>,
    14, false>
    field_behavior(kFieldBehaviorFieldNumber,
                   static_cast<::google::api::FieldBehavior>(0));
