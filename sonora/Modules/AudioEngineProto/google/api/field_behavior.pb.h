...
{
    static_assert(
        std::is_same<T, FieldBehavior>::value || std::is_integral<T>::value,
...
inline const std::string& FieldBehavior_Name(FieldBehavior value)
{
    return ::google::protobuf::internal::NameOfDenseEnum<
        FieldBehavior_descriptor, 0, 8>(static_cast<int>(value));
}
...
extern ::google::protobuf::internal::ExtensionIdentifier<
    ...
    ::google::protobuf::internal::RepeatedEnumTypeTraits<
        ::google::api::FieldBehavior, ::google::api::FieldBehavior_IsValid>,
    14, false>
    field_behavior;
