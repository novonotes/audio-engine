...
inline constexpr ResourceReference::Impl_::Impl_(
    ...
    , child_type_(&::google::protobuf::internal::fixed_address_empty_string,
                  ::_pbi::ConstantInitialized())
    , _cached_size_{0}
{}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ResourceReferenceDefaultTypeInternal
...
inline constexpr ResourceDescriptor::Impl_::Impl_(
    ...
    , type_(&::google::protobuf::internal::fixed_address_empty_string,
            ::_pbi::ConstantInitialized())
    , name_field_(&::google::protobuf::internal::fixed_address_empty_string,
                  ::_pbi::ConstantInitialized())
    , plural_(&::google::protobuf::internal::fixed_address_empty_string,
              ::_pbi::ConstantInitialized())
    , singular_(&::google::protobuf::internal::fixed_address_empty_string,
                ::_pbi::ConstantInitialized())
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ResourceDescriptorDefaultTypeInternal
...
const ::uint32_t TableStruct_google_2fapi_2fresource_2eproto::offsets
    [] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::google::api::ResourceDescriptor,
                              _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ...
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::google::api::ResourceReference,
                              _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ~0u,  // no _weak_field_map_
...
const char descriptor_table_protodef_google_2fapi_2fresource_2eproto
    [] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
...
PROTOBUF_CONSTINIT const uint32_t
    ResourceDescriptor_History_internal_data_[] = {
        196608u,
        0u,
};
...
constexpr ResourceDescriptor_History
    ResourceDescriptor::ORIGINALLY_SINGLE_PATTERN;
...
inline PROTOBUF_NDEBUG_INLINE ResourceDescriptor::Impl_::Impl_(
    ...
    const ::google::api::ResourceDescriptor& from_msg)
...
const ::google::protobuf::MessageLite::ClassDataFull
    ResourceDescriptor::_class_data_ = {
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
            ::google::protobuf::Message::GetDeleteImpl<ResourceDescriptor>(),
            ::google::protobuf::Message::GetNewImpl<ResourceDescriptor>(),
            ::google::protobuf::Message::GetClearImpl<ResourceDescriptor>(),
            &ResourceDescriptor::ByteSizeLong,
    ...
    ResourceDescriptor::_table_ = {
        {
            ...
            ::_pbi::TcParser::GetTable<
                ::google::api::ResourceDescriptor>(),  // to_prefetch
        ...
        {{
            ...
            {::_pbi::TcParser::SingularVarintNoZag1<
                 ::uint32_t, offsetof(ResourceDescriptor, _impl_.history_),
                 63>(),
             {32, 63, 0,
        ...
        {{
            ...
            {PROTOBUF_FIELD_OFFSET(ResourceDescriptor, _impl_.pattern_), 0, 0,
             (0 | ::_fl::kFcRepeated | ::_fl::kUtf8String |
              ::_fl::kRepSString)},
            // string name_field = 3;
            {PROTOBUF_FIELD_OFFSET(ResourceDescriptor, _impl_.name_field_), 0,
             0,
             (0 | ::_fl::kFcSingular | ::_fl::kUtf8String |
              ::_fl::kRepAString)},
            // .google.api.ResourceDescriptor.History history = 4;
...
{
    const ResourceDescriptor& this_ =
        static_cast<const ResourceDescriptor&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
::uint8_t* ResourceDescriptor::_InternalSerialize(
    ::uint8_t* target,
    ::google::protobuf::io::EpsCopyOutputStream* stream) const
{
    ...
    // repeated .google.api.ResourceDescriptor.Style style = 10;
    {
        std::size_t byte_size = this_._impl_._style_cached_byte_size_.Get();
        if(byte_size > 0)
        {
            target = stream->WriteEnumPacked(10, this_._internal_style(),
                                             byte_size, target);
        }
    }
...
::size_t ResourceDescriptor::ByteSizeLong() const
{
    ...
    ::_pbi::Prefetch5LinesFrom7Lines(&this_);
    {
        ...
        // repeated .google.api.ResourceDescriptor.Style style = 10;
        {
            ...
            auto count = static_cast<std::size_t>(this_._internal_style_size());

            for(std::size_t i = 0; i < count; ++i)
            {
                data_size += ::_pbi::WireFormatLite::EnumSize(
                    this_._internal_style().Get(static_cast<int>(i)));
            }
            ...
            this_._impl_._style_cached_byte_size_.Set(
    ...
    }
    {
        ...
        {
            total_size +=
                1 + ::_pbi::WireFormatLite::EnumSize(this_._internal_history());
        }
    }
...
void ResourceDescriptor::MergeImpl(
...
void ResourceDescriptor::InternalSwap(
    ResourceDescriptor* PROTOBUF_RESTRICT other)
{
    using std::swap;
    auto* arena = GetArena();
    ...
    ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.type_, &other->_impl_.type_,
                                         arena);
    ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.name_field_,
                                         &other->_impl_.name_field_, arena);
    ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.plural_,
                                         &other->_impl_.plural_, arena);
    ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.singular_,
                                         &other->_impl_.singular_, arena);
...
inline PROTOBUF_NDEBUG_INLINE ResourceReference::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* arena, const Impl_& from,
    const ::google::api::ResourceReference& from_msg)
    : type_(arena, from.type_)
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::MessageLite::ClassDataFull
    ResourceReference::_class_data_ = {
        ::google::protobuf::Message::ClassData{
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
            ::google::protobuf::Message::GetDeleteImpl<ResourceReference>(),
            ::google::protobuf::Message::GetNewImpl<ResourceReference>(),
            ::google::protobuf::Message::GetClearImpl<ResourceReference>(),
            &ResourceReference::ByteSizeLong,
...
#ifdef PROTOBUF_PREFETCH_PARSE_TABLE
            ::_pbi::TcParser::GetTable<
                ::google::api::ResourceReference>(),  // to_prefetch
#endif  // PROTOBUF_PREFETCH_PARSE_TABLE
        },
        {{
            // string child_type = 2;
...
::uint8_t* ResourceReference::_InternalSerialize(
    ...
    ::google::protobuf::io::EpsCopyOutputStream* stream)
{
    const ResourceReference& this_ =
        static_cast<const ResourceReference&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
::uint8_t* ResourceReference::_InternalSerialize(
    ::uint8_t* target,
    ::google::protobuf::io::EpsCopyOutputStream* stream) const
...
void ResourceReference::MergeImpl(
    ::google::protobuf::MessageLite& to_msg,
    const ::google::protobuf::MessageLite& from_msg)
{
...
void ResourceReference::InternalSwap(ResourceReference* PROTOBUF_RESTRICT other)
{
    ...
    ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.type_, &other->_impl_.type_,
                                         arena);
    ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.child_type_,
                                         &other->_impl_.child_type_, arena);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 ::_pbi::ExtensionIdentifier<
    ...
    ::_pbi::MessageTypeTraits<::google::api::ResourceReference>, 11, false>
    resource_reference(kResourceReferenceFieldNumber,
                       &::google::api::_ResourceReference_default_instance_);
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 ::_pbi::ExtensionIdentifier<
    ::google::protobuf::FileOptions,
    ::_pbi::RepeatedMessageTypeTraits<::google::api::ResourceDescriptor>, 11,
    false>
    resource_definition(kResourceDefinitionFieldNumber,
                        &::google::api::_ResourceDescriptor_default_instance_);
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 ::_pbi::ExtensionIdentifier<
    ::google::protobuf::MessageOptions,
    ::_pbi::MessageTypeTraits<::google::api::ResourceDescriptor>, 11, false>
    resource(kResourceFieldNumber,
             &::google::api::_ResourceDescriptor_default_instance_);
    ...
    PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(
         ...
         ::_pbi::ExtensionSet::RegisterMessageExtension(
             ...
             false, false,
             &::google::api::ResourceReference::default_instance(), nullptr,
             ::_pbi::LazyAnnotation::kUndefined),
         ::_pbi::ExtensionSet::RegisterMessageExtension(
             &::google::protobuf::FileOptions::default_instance(), 1053, 11,
             true, false,
             &::google::api::ResourceDescriptor::default_instance(), nullptr,
             ::_pbi::LazyAnnotation::kUndefined),
         ::_pbi::ExtensionSet::RegisterMessageExtension(
