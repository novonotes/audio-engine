...
inline constexpr Any::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : type_url_(&::google::protobuf::internal::fixed_address_empty_string,
...
const ::uint32_t TableStruct_google_2fprotobuf_2fany_2eproto::offsets
...
Any::Any(::google::protobuf::Arena* arena, const Any& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base())
{
#else   // PROTOBUF_CUSTOM_VTABLE
...
const ::google::protobuf::MessageLite::ClassDataFull Any::_class_data_ = {
    ...
    &Any::kDescriptorMethods, &descriptor_table_google_2fprotobuf_2fany_2eproto,
    nullptr,  // tracker
};
...
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<1, 2, 0, 36, 2>
    Any::_table_ = {
        {
            0,     // no _has_bits_
            0,     // no _extensions_
            ...
            ::_pbi::TcParser::GetTable<
                ::google::protobuf::Any>(),  // to_prefetch
...
void Any::InternalSwap(Any* PROTOBUF_RESTRICT other)
{
    ...
    ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.type_url_,
                                         &other->_impl_.type_url_, arena);
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type _static_init2_
    PROTOBUF_UNUSED = (::_pbi::AddDescriptors(
                           &descriptor_table_google_2fprotobuf_2fany_2eproto),
                       ::std::false_type{});
