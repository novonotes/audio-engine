...
const ::uint32_t TableStruct_google_2fprotobuf_2fempty_2eproto::offsets
...
Empty::Empty(::google::protobuf::Arena* arena, const Empty& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::internal::ZeroFieldsBase(arena, _class_data_.base())
{
#else   // PROTOBUF_CUSTOM_VTABLE
...
const ::google::protobuf::MessageLite::ClassDataFull Empty::_class_data_ = {
    ...
    Empty::_table_ = {
        {
            ...
            ::_pbi::TcParser::GetTable<
                ::google::protobuf::Empty>(),  // to_prefetch
