...
inline constexpr ListValue::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : values_{}
    , _cached_size_{0}
{}
...
inline constexpr Struct::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : fields_{}
    , _cached_size_{0}
{}
...
const ::uint32_t TableStruct_google_2fprotobuf_2fstruct_2eproto::offsets
    [] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        PROTOBUF_FIELD_OFFSET(::google::protobuf::Struct_FieldsEntry_DoNotUse,
                              _impl_._has_bits_),
        PROTOBUF_FIELD_OFFSET(::google::protobuf::Struct_FieldsEntry_DoNotUse,
                              _internal_metadata_),
        ~0u,  // no _extensions_
        ...
        ~0u,  // no _extensions_
        PROTOBUF_FIELD_OFFSET(::google::protobuf::Value,
        ...
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::google::protobuf::ListValue,
                              _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ~0u,  // no _weak_field_map_
...
static const ::_pb::Message* const file_default_instances[] = {
    &::google::protobuf::_Struct_FieldsEntry_DoNotUse_default_instance_
         ._instance,
...
bool NullValue_IsValid(int value) { return 0 <= value && value <= 0; }
// ===================================================================
...
#endif  // PROTOBUF_CUSTOM_VTABLE
            PROTOBUF_FIELD_OFFSET(Struct_FieldsEntry_DoNotUse,
    ...
    Struct_FieldsEntry_DoNotUse::_table_ = {
        {
            ...
            ::_pbi::TcParser::GetTable<
                ::google::protobuf::
                    Struct_FieldsEntry_DoNotUse>(),  // to_prefetch
...
Struct::Struct(::google::protobuf::Arena* arena, const Struct& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base())
{
#else   // PROTOBUF_CUSTOM_VTABLE
...
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::MessageLite::ClassDataFull Struct::_class_data_ = {
    ::google::protobuf::Message::ClassData{
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<
    ...
    Struct::_table_ = {
...
#ifdef PROTOBUF_PREFETCH_PARSE_TABLE
            ::_pbi::TcParser::GetTable<
                ::google::protobuf::Struct>(),  // to_prefetch
#endif                                          // PROTOBUF_PREFETCH_PARSE_TABLE
        },
        {{
        ...
        {{
            {::_pbi::TcParser::GetMapAuxInfo<decltype(Struct()._impl_.fields_)>(
                1, 0, 0, 9, 11)},
    ...
    ::google::protobuf::io::EpsCopyOutputStream* stream) const
{
    ...
    if(!this_._internal_fields().empty())
    {
        ...
        using WireHelper =
            _pbi::MapEntryFuncs<std::string, ::google::protobuf::Value,
    ...
    : ::google::protobuf::Message(arena)
{
    ...
    switch(kind_case())
    {
        ...
        case kNumberValue:
            ...
            break;
        case kStringValue:
            new(&_impl_.kind_.string_value_) decltype(_impl_.kind_
                                                          .string_value_){
        ...
        case kStructValue:
            _impl_.kind_.struct_value_ =
                ::google::protobuf::Message::CopyConstruct<
                    ::google::protobuf::Struct>(
                    arena, *from._impl_.kind_.struct_value_);
            break;
        case kListValue:
            _impl_.kind_.list_value_ =
                ::google::protobuf::Message::CopyConstruct<
                    ::google::protobuf::ListValue>(
                    arena, *from._impl_.kind_.list_value_);
            break;
    }
...
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::MessageLite::ClassDataFull Value::_class_data_ = {
    ::google::protobuf::Message::ClassData{
...
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<0, 6, 2, 42, 2>
    Value::_table_ = {
        {
            0,     // no _has_bits_
            0,     // no _extensions_
...
#ifdef PROTOBUF_PREFETCH_PARSE_TABLE
            ::_pbi::TcParser::GetTable<
                ::google::protobuf::Value>(),  // to_prefetch
#endif                                         // PROTOBUF_PREFETCH_PARSE_TABLE
        },
        {{
            {::_pbi::TcParser::MiniParse, {}},
        ...
        {{
            ...
            {PROTOBUF_FIELD_OFFSET(Value, _impl_.kind_.null_value_),
             _Internal::kOneofCaseOffset + 0, 0,
             (0 | ::_fl::kFcOneof | ::_fl::kOpenEnum)},
            // double number_value = 2;
            {PROTOBUF_FIELD_OFFSET(Value, _impl_.kind_.number_value_),
             _Internal::kOneofCaseOffset + 0, 0,
            ...
            {PROTOBUF_FIELD_OFFSET(Value, _impl_.kind_.struct_value_),
             _Internal::kOneofCaseOffset + 0, 0,
             (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
            // .google.protobuf.ListValue list_value = 6;
            {PROTOBUF_FIELD_OFFSET(Value, _impl_.kind_.list_value_),
    ...
    ::google::protobuf::io::EpsCopyOutputStream* stream) const
{
    ...
    switch(this_.kind_case())
    {
        ...
        case kStructValue:
        {
            target = ::google::protobuf::internal::WireFormatLite::
                InternalWriteMessage(
                    5, *this_._impl_.kind_.struct_value_,
                    this_._impl_.kind_.struct_value_->GetCachedSize(), target,
                    stream);
            break;
        }
        case kListValue:
        {
            target = ::google::protobuf::internal::WireFormatLite::
                InternalWriteMessage(
                    6, *this_._impl_.kind_.list_value_,
                    this_._impl_.kind_.list_value_->GetCachedSize(), target,
                    stream);
            break;
        }
        default:
...
::size_t Value::ByteSizeLong() const
{
    ...
    switch(this_.kind_case())
    {
        ...
        case kStructValue:
        {
            total_size +=
                1 + ::google::protobuf::internal::WireFormatLite::MessageSize(
                        *this_._impl_.kind_.struct_value_);
            break;
        }
        // .google.protobuf.ListValue list_value = 6;
        case kListValue:
        {
            total_size +=
                1 + ::google::protobuf::internal::WireFormatLite::MessageSize(
                        *this_._impl_.kind_.list_value_);
            break;
        }
        case KIND_NOT_SET:
        {
                      ...
                      const ::google::protobuf::MessageLite& from_msg)
{
    ...
    if(const uint32_t oneof_from_case = from._impl_._oneof_case_[0])
    {
        ...
        switch(oneof_from_case)
        {
            ...
            case kNumberValue:
            {
                _this->_impl_.kind_.number_value_ =
                    from._impl_.kind_.number_value_;
                break;
            }
            case kStringValue:
            {
                ...
                _this->_impl_.kind_.string_value_.Set(
                    from._internal_string_value(), arena);
                break;
            }
            case kBoolValue:
            {
            ...
            case kStructValue:
            {
                ...
                {
                    _this->_impl_.kind_.struct_value_->MergeFrom(
            ...
            case kListValue:
            {
                ...
                {
                    _this->_impl_.kind_.list_value_->MergeFrom(
...
ListValue::ListValue(::google::protobuf::Arena* arena, const ListValue& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base())
{
#else   // PROTOBUF_CUSTOM_VTABLE
...
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::MessageLite::ClassDataFull ListValue::_class_data_ = {
    ::google::protobuf::Message::ClassData{
...
const ::google::protobuf::MessageLite::ClassData* ListValue::GetClassData()
    const
{
    ::google::protobuf::internal::PrefetchToLocalCache(&_class_data_);
    ::google::protobuf::internal::PrefetchToLocalCache(_class_data_.tc_table);
...
#ifdef PROTOBUF_PREFETCH_PARSE_TABLE
            ::_pbi::TcParser::GetTable<
                ::google::protobuf::ListValue>(),  // to_prefetch
#endif  // PROTOBUF_PREFETCH_PARSE_TABLE
        },
        {{
