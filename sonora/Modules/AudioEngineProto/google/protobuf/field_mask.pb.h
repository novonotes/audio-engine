...
/* @@protoc_insertion_point(class_definition:google.protobuf.FieldMask) */ {
   ...
   private:
    const ::google::protobuf::RepeatedPtrField<std::string>& _internal_paths()
        const;
   ...
   private:
    ...
    static const ::google::protobuf::internal::TcParseTable<0, 1, 0, 39, 2>
        _table_;
...
inline void FieldMask::set_paths(int index, Arg_&& value, Args_... args)
{
    ::google::protobuf::internal::AssignToString(
        *_internal_mutable_paths()->Mutable(index), std::forward<Arg_>(value),
        args...);
