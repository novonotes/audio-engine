...
inline constexpr Timestamp::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : seconds_{::int64_t{0}}
    , nanos_{0}
    , _cached_size_{0}
{}
...
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_google_2fprotobuf_2ftimestamp_2eproto =
        nullptr;
const ::uint32_t TableStruct_google_2fprotobuf_2ftimestamp_2eproto::offsets
    [] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::google::protobuf::Timestamp,
                              _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
...
Timestamp::Timestamp(::google::protobuf::Arena* arena, const Timestamp& from)
    : Timestamp(arena)
{
    MergeFrom(from);
}
...
inline void Timestamp::SharedCtor(::_pb::Arena* arena)
{
    ...
    ::memset(reinterpret_cast<char*>(&_impl_) + offsetof(Impl_, seconds_), 0,
             offsetof(Impl_, nanos_) - offsetof(Impl_, seconds_) +
                 sizeof(Impl_::nanos_));
}
Timestamp::~Timestamp()
{
...
const ::google::protobuf::MessageLite::ClassDataFull Timestamp::_class_data_ = {
...
const ::google::protobuf::MessageLite::ClassData* Timestamp::GetClassData()
    const
{
    ...
    Timestamp::_table_ = {
        {
            ...
            ::_pbi::TcParser::GetTable<
                ::google::protobuf::Timestamp>(),  // to_prefetch
#endif  // PROTOBUF_PREFETCH_PARSE_TABLE
        },
        {{
            // int32 nanos = 2;
            {::_pbi::TcParser::SingularVarintNoZag1<
                 ::uint32_t, offsetof(Timestamp, _impl_.nanos_), 63>(),
             {16, 63, 0, PROTOBUF_FIELD_OFFSET(Timestamp, _impl_.nanos_)}},
            // int64 seconds = 1;
            {::_pbi::TcParser::SingularVarintNoZag1<
                 ::uint64_t, offsetof(Timestamp, _impl_.seconds_), 63>(),
    ...
    ::google::protobuf::io::EpsCopyOutputStream* stream) const
{
    ...
    if(this_._internal_seconds() != 0)
    {
        target = ::google::protobuf::internal::WireFormatLite::
            WriteInt64ToArrayWithField<1>(stream, this_._internal_seconds(),
                                          target);
    }
    ...
    {
        target = ::google::protobuf::internal::WireFormatLite::
            WriteInt32ToArrayWithField<2>(stream, this_._internal_nanos(),
                                          target);
    }
