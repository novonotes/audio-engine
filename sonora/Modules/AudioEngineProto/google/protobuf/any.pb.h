...
/* @@protoc_insertion_point(class_definition:google.protobuf.Any) */ {
   ...
   protected:
    ...
    Any(::google::protobuf::Arena* arena, Any&& from) noexcept : Any(arena)
    {
        *this = ::std::move(from);
    }
   ...
   private:
    ...
    static const ::google::protobuf::internal::TcParseTable<1, 2, 0, 36, 2>
        _table_;
...
inline const std::string& Any::type_url() const ABSL_ATTRIBUTE_LIFETIME_BOUND
{
...
inline const std::string& Any::value() const ABSL_ATTRIBUTE_LIFETIME_BOUND
{
