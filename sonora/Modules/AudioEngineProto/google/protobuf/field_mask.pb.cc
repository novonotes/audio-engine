...
inline constexpr FieldMask::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : paths_{}
    , _cached_size_{0}
{}
...
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_google_2fprotobuf_2ffield_5fmask_2eproto =
        nullptr;
const ::uint32_t TableStruct_google_2fprotobuf_2ffield_5fmask_2eproto::offsets
    [] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::google::protobuf::FieldMask,
                              _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
...
FieldMask::FieldMask(::google::protobuf::Arena* arena, const FieldMask& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base())
{
#else   // PROTOBUF_CUSTOM_VTABLE
...
const ::google::protobuf::MessageLite::ClassDataFull FieldMask::_class_data_ = {
...
const ::google::protobuf::MessageLite::ClassData* FieldMask::GetClassData()
    const
{
...
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<0, 1, 0, 39, 2>
    FieldMask::_table_ = {
        {
            0,     // no _has_bits_
            0,     // no _extensions_
            ...
            ::_pbi::TcParser::GetTable<
                ::google::protobuf::FieldMask>(),  // to_prefetch
